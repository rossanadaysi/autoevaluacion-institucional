...
public class informeDetalleCaracteristicaAI implements Action {
    ...
    public String procesar(HttpServletRequest request) throws IOException, ServletException {
        ...
        String sql2 = "SELECT caracteristica.id AS cid, caracteristica.nombre AS cno, indicador.id, indicador.nombre, format(avg(respuesta),2), factor.id, indicador.codigo, factor.nombre"
                + " FROM Caracteristica"
