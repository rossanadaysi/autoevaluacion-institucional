    ...
    <body>
        ...
        <div class="modal hide fade" id="myModalAbout">
            ...
            <div style="background-color: #282728;border-top: 0px;border-radius:0;" class="modal-footer">
                <%-- <a class="btn btn-primary" data-dismiss="modal" href="#">Cerrar</a>--%>
                <p style="color: #FFFFFF;">SIA-UdeC v1.0</p>
                ...
                <p style="color: #FFFFFF;">Desarrollado por esoluciones. </p>
                <p style="color: #FFFFFF;">Martín Monroy Ríos - Oscar Ballesteros Pacheco - Arturo González Villamizar</p>
            </div>
        </div>
    </body>
</html> 
