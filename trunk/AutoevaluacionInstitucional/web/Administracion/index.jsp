...
<html xmlns="http://www.w3.org/1999/xhtml">
                    ...
                    if (aux.equals("Fuente")) {
                        ...
                        if (aux.equals("comitefacultad")) {
                            ...
                            if (aux.equals("Administrador")) {
                                RequestDispatcher rd = request.getRequestDispatcher("/Administracion/administracion.jsp");
                                rd.forward(request, response);
                            }
                        }
                    }
            ...
            $().ready(function() {
                ...
                $("#btnIniciar").click(function(){
                    $.ajax({
                        ...
                        data: 'un='+ $('#codigo').val() +'&pw=' + $('#pass').val() +'&tp=Administrador' ,
                        type: 'post',
                        success: function(msg){
                            ...
                            {                // and direct to the success page
                                ...
                                document.location='/AutoevaluacionInstitucional/Administracion/';
    ...
    <body>
            ...
            <div class="navbar navbar-fixed-top">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <a class="brand" style="padding-bottom: 3px; padding-top: 6px" href="#"><img src="<%=request.getContextPath()%>/css/images/logoSIA.png"></img></a>
        ...
        <div id="centerIndex" class="ui-layout-center" style="background-color: #f5f5f5;">
