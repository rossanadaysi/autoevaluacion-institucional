...
addButton:function(a){
    function b(){
        ...
        var c=this,d=c.renderer,e=s(c.options.navigation.buttonOptions,a),g=e.onclick,f=e.menuItems,h=e.width,k=e.height,o,p,q,a=e.borderWidth,j={
...
y.prototype.callbacks.push(function(a){
    ...
    if(c.enabled!==!1){
        for(b in d)a.addButton(d[b]);z(a,"destroy",a.destroyExport)
        }
    })
})();
