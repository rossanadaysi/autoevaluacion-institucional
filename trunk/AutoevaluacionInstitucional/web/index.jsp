    ...
    <body>
        ...
        <div class="ui-layout-center">
            <div style="height: 68%; background-color: #f77f00;">
                ...
                <div style="z-index: 5;float: left;position:relative;top:25%;left: 4%;width: 26%;color: #FAF4E3;"><h2>La Oficina de Autoevaluaci&oacute;n de la Universidad de Cartagena cuenta con el Sistema de Autoevaluaci&oacute;n Institucional SIA que sirve de Apoyo a los procesos de autoevaluación con fines de Acreditación.</h2></div>     
            </div>
