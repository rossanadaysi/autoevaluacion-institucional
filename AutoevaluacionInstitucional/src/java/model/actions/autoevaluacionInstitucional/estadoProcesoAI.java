...
public class estadoProcesoAI implements Action {
    ...
    public String procesar(HttpServletRequest request) throws IOException, ServletException {
        ...
        String sql2 = "select * from("
                ...
                + " where muestraestudiante.muestra_id="+idMuestra+" and encabezado.fuente_id=1) as est,"
                ...
                + " where muestradocente.muestra_id="+idMuestra+" and encabezado.fuente_id=2) as doc,"
                ...
                + " where muestraadministrativo.muestra_id="+idMuestra+" and encabezado.fuente_id=3) as adm,"
                ...
                + " where muestradirector.muestra_id="+idMuestra+" and encabezado.fuente_id=4) as dir,"
                ...
                + " where muestraegresado.muestra_id="+idMuestra+" and encabezado.fuente_id=5) as egr,"
                ...
                + " where muestraempleador.muestra_id="+idMuestra+" and encabezado.fuente_id=6) as emp,"
                ...
                + " where muestraagencia.muestra_id="+idMuestra+" and encabezado.fuente_id=7 ) as age)";
