...
public class informeMatrizAI implements Action {
    ...
    public String procesar(HttpServletRequest request) throws IOException, ServletException {
        ...
        Result matriz = null;
        String sql2 = "select c1.cara, c1.nombre, c1.nivel, c1.ponderacionCara, avg(c1.cumplimiento), avg(cumplimiento)*c1.ponderacionCara, 5*c1.ponderacionCara, avg(cumplimiento)*20 , c1.fid   from(\n"
                + "\n"
