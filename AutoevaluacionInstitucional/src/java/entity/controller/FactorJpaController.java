...
public class FactorJpaController implements Serializable {
        ...
        try {
            ...
            for (Caracteristica caracteristicaListOldCaracteristica : caracteristicaListOld) {
                if (!caracteristicaListNew.contains(caracteristicaListOldCaracteristica)) {
                    ...
                    illegalOrphanMessages.add("You must retain Caracteristica " + caracteristicaListOldCaracteristica + " since its factorId field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<String> illegalOrphanMessages = null;
            List<Caracteristica> caracteristicaListOrphanCheck = factor.getCaracteristicaList();
            for (Caracteristica caracteristicaListOrphanCheckCaracteristica : caracteristicaListOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Factor (" + factor + ") cannot be destroyed since the Caracteristica " + caracteristicaListOrphanCheckCaracteristica + " in its caracteristicaList field has a non-nullable factorId field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
