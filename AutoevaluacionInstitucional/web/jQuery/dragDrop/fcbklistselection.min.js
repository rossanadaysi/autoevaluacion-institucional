...
d.css("width",h+"px");
(function(b,c){
    c='<div id="filters" style="width:'+(parseInt(c,10)+2)+'px;"><ul class="selections" id="selections"><li id="view_all" class="view_on"><a onclick="return false;" href="#">Ver Todo</a></li><li id="view_selected" class=""><a onclick="return false;" href="#">Seleccionados (<strong id="view_selected_count">0</strong>)</a></li><li id="view_unselected" class=""><a onclick="return false;" href="#">No Seleccionados</a></li></ul><div class="clearer"></div></div>';
    b.before(c)
    })(d, h);
(function(b,c,a,e){
