    ...
    var bindEventsOnItems = function(elem){
        $.each(elem.children("li").children(".fcbklist_item"), function(i, obj){
            ...
            if (obj.children("input[checked]").length != 0) {
                ...
                if(obj.parents("li").attr("id").indexOf("itemblock")!=-1){
                    if(obj.parents("li").attr("id")=="itemblockRojo"){
                        obj.toggleClass("itemselectedRojo");
                        obj.parents("li").toggleClass("itemselectedRojo");
                        
                    }else{
                        if(obj.parents("li").attr("id")=="itemblockAzul"){
                            obj.toggleClass("itemselectedAzul");
                            obj.parents("li").toggleClass("itemselectedAzul");
                        }else{
                            if(obj.parents("li").attr("id")=="itemblockVerde"){
                                obj.toggleClass("itemselectedVerde");
                                obj.parents("li").toggleClass("itemselectedVerde");
                            }
                        }
                    }
                }
            ...
            obj.click(function(){
                ...
                if(id!="itemblockVerde" && id!="itemblockAzul"){
                    addToSelected(obj);
                    obj.toggleClass("itemselected");
                    obj.parents("li").toggleClass("liselected");
